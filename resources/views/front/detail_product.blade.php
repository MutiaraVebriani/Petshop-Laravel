    ...
    <div class="col-md-6">
        ...
        <div class="box">
            <div class="box-body box-profile">
                ...
                {{--<h3><p class="text-muted text-center">Rp. {{ number_format($product->price, 0) }}</p>
                </h3>--}}
            </div>
            <!-- /.box-body -->
        </div>
            ...
            <div class="box">
                <div class="box-body box-profile">
                    ...
                    <button class="btn btn-info">
                        <h4>Stock Product {{ $product->stock }} Pcs</h4>
                    </button>

                    <h3>Description</h3>
                    <h4>{{ $product->description }}</h4>
                    <br>
                    <p><a href="{{ url('add-to-cart/'.$product->id) }}" class="btn btn-success btn-block"><b>Add To
                                Cart</b></a>
