<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
            </li>
            ...
            <li><a href="{{ route('confirmAdmin') }}"><i class="fa fa-dollar "></i> <span>Konfirmasi
                        Pembayaran</span></a></li>
            <li class="active"><a href="{{ url('/order') }}"><i class="fa  fa-exchange"></i> <span>List Order</span></a>
            </li>
        </ul>
        @endif
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <!-- Optionally, you can add icons to the links -->
            <li class="active"><a href="{{ url('/invoice/list') }}"><i class="fa fa-reply"></i> <span>List Konfirmasi
                        Order</span></a></li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="{{ url('product/category/'.$category->slug) }}">
                            ...
                            <span>{{ $category->name }} <small
                                    class="label pull-right bg-maroon-active">{{ $category->products()->count() }}</small></span>
                        </a>
                    </li>
                    @endforeach
                </ul>
