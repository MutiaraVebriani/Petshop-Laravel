<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="{{ url('/invoice/list') }}"><i class="fa fa-link"></i> <span>List Pesanan
                        Anda</span></a></li>
        </ul>
        @endif
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li><a href="{{ url('/shopping-cart') }}"><i class="fa fa-link"></i> <span>Shoppingg Cart</span></a></li>
